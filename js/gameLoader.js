const gameLinks = {
    ...
    'Wormate.io': 'https://floopynetworkgamingservice.github.io/rtyugu/',
    'DeathCar.io': 'https://floopynetworkgamingservice.github.io/dfghghdjghj/',
    'Animal.io': 'https://floopynetworkgamingservice.github.io/fghkyufkft/',
    'Drift Dudes': 'https://floopynetworkgamingservice.github.io/rtyuyuyu/',
    'Stair Race 3D': 'https://floopynetworkgamingservice.github.io/vbnggcvnvghc/',
    'WarriorSurvival.io': 'https://floopynetworkgamingservice.github.io/fdsdfsdf/',
    'Super Mario 64': 'https://floopynetworkgamingservice.github.io/dfghfghdfgh/',
    'Trains.io': 'https://floopynetworkgamingservice.github.io/cvbfghhg/',
    'EatTheFish.io': 'https://floopynetworkgamingservice.github.io/fghfghdfght/',
...
const gameDescriptions = {
    ...
    'Brawl Stars (Scratch)': 'Brawl Stars is a popular multiplayer online game developed by Supercell that offers a fast-paced and action-packed experience for players of all ages. In the game, players control a variety of colorful characters, each with unique abilities and playstyles, as they compete in various game modes and challenges. With its vibrant graphics, engaging gameplay, and competitive multiplayer mode, Brawl Stars offers an immersive and thrilling experience that keeps players coming back for more. The game has gained a large following and continues to receive updates and new content regularly, making it a favorite among fans of mobile gaming and online multiplayer.',
    'Hole.io': 'Hole.io is a popular multiplayer online game that challenges players to control a black hole and consume objects and opponents to grow in size. Developed by Voodoo, the game features simple controls and addictive gameplay that encourages players to strategize and outmaneuver opponents. With its minimalist graphics, competitive multiplayer mode, and dynamic gameplay, Hole.io offers an engaging and thrilling experience that keeps players coming back for more. The game has gained a large following and continues to receive updates and new content regularly, making it a favorite among fans of browser-based games and casual gaming.',
    'Aquapark.io': 'Aquapark.io is a thrilling and fast-paced water slide racing game that plunges players into a vibrant and chaotic aquapark adventure. Players race against others as they slide down winding and twisting water slides, aiming to be the first to reach the finish line. Along the way, they can bump opponents off the slide, take shortcuts, and perform daring stunts to gain an edge. With its colorful graphics, simple controls, and addictive gameplay, Aquapark.io offers endless fun and excitement. Perfect for players seeking a fun and competitive racing experience, this game delivers high-speed thrills and aquatic mayhem.',
    'Wormate.io': 'Wormate.io is a popular multiplayer online game that challenges players to control a colorful worm and consume food to grow in size while avoiding other worms that can consume them. Developed by Oleksandr Godoba, the game features simple controls and addictive gameplay that encourages players to strategize and outmaneuver opponents. With its vibrant graphics, competitive multiplayer mode, and dynamic gameplay, Wormate.io offers an engaging and thrilling experience that keeps players coming back for more. The game has gained a large following and continues to receive updates and new content regularly, making it a favorite among fans of browser-based games and casual gaming.',
    'DeathCar.io': 'DeathCar.io is a fast-paced and action-packed multiplayer online game that challenges players to control a vehicle and eliminate opponents in a chaotic arena. Players must drive around the map, trying to survive and crash to destroy enemy vehicles while avoiding hazards and obstacles. With its vibrant graphics, dynamic environments, and intense gameplay, DeathCar.io offers an engaging and thrilling experience that keeps players coming back for more. The game features various game modes, customization options, and competitive leaderboards, making it a favorite among fans of vehicular combat and online multiplayer games.',
    'Animal.io': 'Animal.io is a popular multiplayer online game that challenges players to control a variety of animals and compete against others in a chaotic arena. Developed by Tap2Play, the game features simple controls and addictive gameplay that encourages players to strategize and outmaneuver opponents. With its vibrant graphics, competitive multiplayer mode, and dynamic gameplay, Animal.io offers an engaging and thrilling experience that keeps players coming back for more. The game has gained a large following and continues to receive updates and new content regularly, making it a favorite among fans of browser-based games and casual gaming.',
    'Drift Dudes': 'Drift Dudes is a fast-paced and action-packed racing game that challenges players to drift around corners, perform stunts, and outmaneuver opponents in a variety of thrilling tracks. Developed by Madpuffers, the game features intuitive controls, realistic physics, and smooth animations that capture the excitement and intensity of drift racing. Players can customize their cars, upgrade their skills, and unlock new tracks and challenges as they progress through the game. With its engaging gameplay, vibrant graphics, and competitive multiplayer modes, Drift Dudes offers an immersive and thrilling racing experience that appeals to racing fans and gamers alike.',
    'Stair Race 3D': 'Stair Race 3D is an exhilarating and competitive racing game where players dash to build stairs and reach the top first. In this game, you collect colorful stair pieces scattered throughout the course and quickly assemble them to climb over obstacles and outpace your opponents. Featuring vibrant graphics, smooth controls, and dynamic level designs, Stair Race 3D offers a unique blend of strategy and speed. Each race presents new challenges and opportunities to showcase your quick thinking and agility. Perfect for fans of action-packed racing games, Stair Race 3D promises endless fun and excitement as you race to be the first to conquer the stairs.',
    'WarriorSurvival.io': 'WarriorSurvival.io is a thrilling and action-packed multiplayer online game that challenges players to survive in a post-apocalyptic world filled with danger and chaos. Players must scavenge for resources, craft weapons, and battle against other survivors to become the last warrior standing. With its vibrant graphics, dynamic environments, and intense gameplay, WarriorSurvival.io offers an engaging and thrilling experience that keeps players coming back for more. The game features various game modes, customization options, and competitive leaderboards, making it a favorite among fans of survival and battle royale games.',
    'Super Mario 64': 'Super Mario 64 is a classic 3D platformer developed by Nintendo that revolutionized the gaming industry with its innovative gameplay and immersive world. In the game, players control Mario as he embarks on a quest to rescue Princess Peach from Bowser and collect Power Stars to unlock new areas in Princess Peach\'s castle. With its open-world design, diverse levels, and iconic characters, Super Mario 64 offers a rich and engaging experience that captivates players of all ages. The game features intuitive controls, vibrant graphics, and a memorable soundtrack that have made it a timeless favorite among fans of the Super Mario series and platformer games in general.',
    'Trains.io': 'Trains.io is a fast-paced and action-packed multiplayer online game that challenges players to control a train and compete against others in a chaotic arena. Players must navigate through the map, collecting passengers and avoiding collisions with other trains to become the longest and most powerful locomotive. With its vibrant graphics, dynamic environments, and intense gameplay, Trains.io offers an engaging and thrilling experience that keeps players coming back for more. The game features various game modes, customization options, and competitive leaderboards, making it a favorite among fans of train simulation and online multiplayer games.',
    'EatTheFish.io': 'EatTheFish.io is a fun and addictive multiplayer online game that challenges players to control a fish and consume smaller fish to grow in size while avoiding larger fish that can consume them. Developed by Kiemura, the game features simple controls and addictive gameplay that encourages players to strategize and outmaneuver opponents. With its vibrant graphics, competitive multiplayer mode, and dynamic gameplay, EatTheFish.io offers an engaging and thrilling experience that keeps players coming back for more. The game has gained a large following and continues to receive updates and new content regularly, making it a favorite among fans of browser-based games and casual gaming.',
