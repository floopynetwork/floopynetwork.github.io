function deleteGameDivs(event) {
    ...
    const gameDescriptions = {
        ...
        'Flight Simulator 3D v2.8': 'Flight Simulator 3D v2.8 is a web-based flight simulation game that allows players to pilot a variety of aircraft through realistic 3D environments. Developed by Thetis Games and Flight Simulators, the game features detailed aircraft models, dynamic weather effects, and immersive sound design that create an authentic flying experience. With its intuitive controls, realistic physics, and stunning visuals, Flight Simulator 3D v2.8 offers a thrilling and engaging flight simulation experience that appeals to aviation enthusiasts and gamers alike.',
